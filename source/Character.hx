	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'updike':
				tex = Paths.getSparrowAtlas('mem/updike_assets', 'shared');
				frames = tex;
			...
			case 'updikeglow':
				tex = Paths.getSparrowAtlas('mem/updike_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'updingdong idle edgy', 24);
				animation.addByPrefix('singUP', 'updingdong up note edgy', 24);
				animation.addByPrefix('singRIGHT', 'updingdong right note edgy', 24);
				animation.addByPrefix('singDOWN', 'updingdong down note edgy', 24);
				animation.addByPrefix('singLEFT', 'updingdong left note edgy', 24);
			...
			case 'gar':
				tex = Paths.getSparrowAtlas('mem/garcello_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'garcello idle dance', 24);
				animation.addByPrefix('singUP', 'garcello Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'garcello Sing Note LEFT', 24);
				animation.addByPrefix('singDOWN', 'garcello Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'garcello Sing Note RIGHT', 24);
			...
			case 'garglow':
				tex = Paths.getSparrowAtlas('mem/garcellodead_assets', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'garcello idle dance', 24);
				animation.addByPrefix('singUP', 'garcello Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'garcello Sing Note LEFT', 24);
